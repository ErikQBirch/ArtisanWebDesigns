...
const pageStuff = {
  ...
  about: function(
    ...
    erik_p = helperFunctions.generateElement('p',"","",
      `Hi! I live in a world that balances between the intracate power of science and the inspiring wonder of art. I am a web designer. I excel in creation and beautification when it comes to websites and always seek oportuanities to help others with my skills. Whether it's  web designing in and of itself, content copywriting, or obtaining a pressence on social media; this is what I do and have been doing for many years.<br><br>
      Web design wasn't always something I dreamed about going into. I orignally wanted to be a chemist/chemical engineer. But with no specific vision and a lack of attraction to the nitty-gritty aspects of lab experiments; I decided to change course and look into something different.<br><br>
      I've always had a thing for art and stories as a kid, but never really pushed myself to get really good at either. So, applying my interest in science and my love for artistry, I choose to become a Web Designer to satisfy both aspects.`),
